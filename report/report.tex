...
Vi har taget udgangspunkt i UCS som beskrevet i bogen Artifi... side 84.
\begin{lstlisting}
...
Vi har udvidet vores program med kode til at tegne en given rute-graf og den fundne rute mellem to knuder. På figur (\ref{copenhagen}) ses hvordan programmet visualiserer en rute gennem København-grafen.
