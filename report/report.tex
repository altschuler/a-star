...
Ellers, hvis \code{frontier} indeholder en \code{State} lig den i \code{child} skal der kontrolleres om den har en lavere \code{PathCost}, og i så fald erstattes.
...
\begin{subfigure}{.5\textwidth}
  ...
  \caption{Her ses søgningen som den bør foregå}
  \label{src:optimal}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{simple_suboptimal.png}
  \caption{Her ses resultatet af søgningen, når den omtalte kontrol undlades}
